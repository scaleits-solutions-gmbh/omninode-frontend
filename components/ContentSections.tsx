        ...
        <div className="grid md:grid-cols-[160px_1fr] gap-6 items-start gradient-card rounded-2xl p-6">
          <div className="h-24 w-24 icon-badge rounded-xl grid place-items-center">
            <svg width="44" height="44" viewBox="0 0 24 24" fill="none" aria-hidden>
              <path d="M12 3l7 4v5c0 5-3.5 8-7 9-3.5-1-7-4-7-9V7l7-4Z" stroke="#7c5cff" strokeWidth="2"/>
              <path d="M12 10a3 3 0 1 1 0 6 3 3 0 0 1 0-6Z" stroke="#7c5cff" strokeWidth="2" opacity=".8"/>
            </svg>
          </div>
          <div>
  ...
  const cards = [
    {
      ...
      icon: (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden>
          <rect x="4" y="5" width="16" height="14" rx="2" stroke="#7c5cff" strokeWidth="2" />
          <path d="M4 9h16" stroke="#7c5cff" strokeWidth="2" opacity=".7" />
        </svg>
      ),
    },
    {
      ...
      icon: (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden>
          <path d="M12 3l8 4v5c0 5-4 7-8 9-4-2-8-4-8-9V7l8-4Z" stroke="#7c5cff" strokeWidth="2" />
        </svg>
      ),
    },
    {
      ...
      icon: (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden>
          <path d="M3 6h18l-9 6-9-6Z" stroke="#7c5cff" strokeWidth="2" />
          <path d="M21 18H3V6" stroke="#7c5cff" strokeWidth="2" opacity=".7" />
        </svg>
      ),
    },
    {
      ...
      icon: (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden>
          <circle cx="12" cy="12" r="8" stroke="#7c5cff" strokeWidth="2" />
          <path d="M12 8v4l3 2" stroke="#7c5cff" strokeWidth="2" opacity=".7" />
        </svg>
      ),
    },
    {
      ...
      icon: (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden>
          <path d="M5 4h14v16H5z" stroke="#7c5cff" strokeWidth="2" />
          <circle cx="12" cy="18" r="1" fill="#7c5cff" />
        </svg>
      ),
    },
    {
      ...
      icon: (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden>
          <rect x="4" y="4" width="6" height="6" stroke="#7c5cff" strokeWidth="2" />
          <rect x="14" y="4" width="6" height="6" stroke="#7c5cff" strokeWidth="2" />
          <rect x="4" y="14" width="6" height="6" stroke="#7c5cff" strokeWidth="2" />
          <rect x="14" y="14" width="6" height="6" stroke="#7c5cff" strokeWidth="2" />
        </svg>
      ),
    },
  ];
