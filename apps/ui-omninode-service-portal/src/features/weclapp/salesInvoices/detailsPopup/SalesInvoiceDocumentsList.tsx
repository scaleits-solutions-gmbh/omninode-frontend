...
import { salesInvoiceDocumentsColumns } from "./SalesInvoiceDocumentsColumns";
import { useQuery } from "@tanstack/react-query";
import { fetchWeclappSalesInvoiceDocuments } from "@/lib/apiClient/weclapp/salesInvoice";
import {
  Table,
  TableBody,
  TableCell,
          ...
          {data?.items && data.items.length > 0 ? (
              ...
              <Table>
                ...
                <TableBody>
                  {table.getRowModel().rows?.length ? (
                    ...
                    <TableRow>
                      <TableCell
                        colSpan={salesInvoiceDocumentsColumns.length}
            ...
            <div className="flex flex-col items-center justify-center py-8 text-center">
              ...
              <p className="text-sm text-muted-foreground">
                No documents available for this salesInvoice.
              </p>
            </div>
          )}
