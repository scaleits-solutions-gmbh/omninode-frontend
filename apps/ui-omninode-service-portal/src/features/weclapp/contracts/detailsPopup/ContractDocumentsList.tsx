...
import { contractDocumentsColumns } from "./ContractDocumentsColumns";
import { useQuery } from "@tanstack/react-query";
import { fetchWeclappContractDocuments } from "@/lib/apiClient/weclapp/contract";
import {
  Table,
  TableBody,
  TableCell,
...
export const ContractDocumentsList = ({ contractId }: ContractDocumentsListProps) => {
  ...
  const { data, isLoading, error } = useQuery({
    ...
    queryFn: () => fetchWeclappContractDocuments(contractId, searchText, page, pageSize),
  });
