...
import { getCompanyByIdQueryKey, updateCompany, invalidateCompaniesQueries } from "@/lib/apiClient";
import { getCompanyById } from "@/lib/apiClient/company/company";
...
function CompanyForm({ data }: { data: Company }) {
  ...
  const updateCompanyMutation = useMutation({
    mutationFn: (company: Company) => updateCompany(company),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: getCompanyByIdQueryKey(data.id) });
