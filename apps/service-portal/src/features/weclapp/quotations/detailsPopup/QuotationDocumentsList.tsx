...
import { quotationDocumentsColumns } from "./QuotationDocumentsColumns";
import { useQuery } from "@tanstack/react-query";
import { fetchWeclappQuotationDocuments } from "@/lib/apiClient/weclapp/quotation";
import {
  Table,
  TableBody,
  TableCell,
      ...
      {data?.items && data.items.length > 0 ? (
          ...
          <Table>
            ...
            <TableBody>
              {table.getRowModel().rows?.length ? (
                ...
                <TableRow>
                  <TableCell
                    colSpan={quotationDocumentsColumns.length}
        ...
        <div className="flex flex-col items-center justify-center py-8 text-center">
          ...
          <p className="text-sm text-muted-foreground">
            No documents available for this quotation.
          </p>
        </div>
      )}
