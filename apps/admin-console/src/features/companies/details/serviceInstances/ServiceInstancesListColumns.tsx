...
import { Service, ServiceInstanceStatus } from "@scaleits-solutions-gmbh/services";
import { formatDate } from "@/lib/utils/misc/dateUtils";
...
export const serviceInstancesColumns = (sourceCompanyId: string): ColumnDef<FeCompanyServiceInstance>[] => [
  {
      ...
      switch (service) {
        case Service.Weclapp:
          return <div className="flex items-center gap-2">
            <Image src={`/assets/services/weclapp.svg`} alt={service} width={16} height={16} />
            Weclapp
          </div>;
        case Service.Acmp:
          return <div className="flex items-center gap-2">
            <Image src={`/assets/services/acmp.svg`} alt={service} width={16} height={16} />
            ACMP
          </div>;
        default:
          return null;
