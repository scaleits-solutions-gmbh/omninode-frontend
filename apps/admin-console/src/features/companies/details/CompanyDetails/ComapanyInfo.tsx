...
import { getCompanyById, getCompanyByIdQueryKey, ApiError, NotFoundError, ValidationError } from "@/lib/apiClient";
import { Avatar, AvatarFallback, AvatarImage } from "@/components/ui/avatar";
import { Badge } from "@/components/ui/badge";
import { Skeleton } from "@/components/ui/skeleton";
import { CompanyType, CompanyStatus } from "@scaleits-solutions-gmbh/services";
...
export default function OrganizationInfo() {
  ...
  if (error) {
    ...
    const getErrorDescription = () => {
      ...
      return error?.message || "An unexpected error occurred while loading company information.";
    };
    ...
    <div className="flex items-center gap-2">
      ...
      <div>
        <div className="flex items-center gap-2">
          ...
          <Badge
            variant={
              data?.status === CompanyStatus.ACTIVE ? "success" : data?.status === CompanyStatus.INACTIVE ? "error" : "secondary"
            }
