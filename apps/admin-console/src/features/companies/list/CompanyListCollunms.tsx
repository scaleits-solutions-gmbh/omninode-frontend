...
export const companyColumns: ColumnDef<Company>[] = [
  ...
  },
  {
    ...
    cell: ({ getValue }) => {
      ...
      return <Badge variant={type === CompanyType.CUSTOMER ? "secondary" : "default"}>{formatCompanyType(type)}</Badge>;
    },
  },
  {
    ...
    cell: ({ getValue }) => {
      ...
      return <span>{formatIndustry(industry.charAt(0).toUpperCase() + industry.slice(1))}</span>;
    },
  },
  {
    accessorKey: "status",
