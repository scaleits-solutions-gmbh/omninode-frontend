...
import { createColumns, PlatformUser } from "./columns";

import { useState } from "react";

import { PlatformUserDetailsPopup } from "../details-popup/platform-user-details-popup";
...
export const PlatformUserList = () => {
  ...
  const [platformUser, setPlatformUser] = useState<PlatformUser | undefined>(
    undefined
  );
  ...
  return (
    <>
      <PlatformUserDetailsPopup
        platformUser={platformUser}
        onClose={() => setPlatformUser(undefined)}
      />
      <Card>
