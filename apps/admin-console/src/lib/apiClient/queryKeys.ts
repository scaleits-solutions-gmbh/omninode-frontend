...
import { FetchCompanyServiceInstancesParams } from './company/companyServiceInstance';
...
export const queryKeys = {
  ...
  companyServiceInstances: {
    ...
    details: () => [...queryKeys.companyServiceInstances.all, 'detail'] as const,
    detail: (id: string) => [...queryKeys.companyServiceInstances.details(), id] as const,
  },
...
export const getCompanyServiceInstancesQueryKey = (params?: FetchCompanyServiceInstancesParams) => 
