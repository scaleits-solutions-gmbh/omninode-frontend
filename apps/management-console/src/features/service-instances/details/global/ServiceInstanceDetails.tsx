...
import EditPopup from "./EditDetailsPopup";
        ...
        <CardContent className="space-y-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col gap-1">
              <h3 className="text-lg font-medium">{serviceInstance.instanceName}</h3>
              <div className="flex items-center gap-2">
                <Badge variant="secondary" className="text-xs">{serviceInstance.service}</Badge>
          ...
          <div className="space-y-4">
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <p className="text-sm">by <span className="font-medium">{serviceInstance.updatedBy}</span></p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-muted-foreground">•</span>
                <p className="text-sm">by <span className="font-medium">{serviceInstance.createdBy}</span></p>
              </div>
            </div>
          </div>
