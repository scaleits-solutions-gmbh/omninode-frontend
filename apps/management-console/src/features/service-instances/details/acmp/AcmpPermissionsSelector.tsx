...
interface AcmpPermissionsSelectorProps {
  form: {
    Field: (props: { name: keyof AcmpPermissionsForm; children: (field: { name: string; state: { value: boolean }; handleChange: (value: boolean) => void }) => React.ReactNode }) => React.ReactNode;
  };
}

export default function AcmpPermissionsSelector({ form }: AcmpPermissionsSelectorProps) {
  return (
