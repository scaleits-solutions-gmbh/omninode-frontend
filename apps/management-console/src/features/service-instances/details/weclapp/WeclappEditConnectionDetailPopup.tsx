...
import { FeWeclappServiceInstanceDetails } from "@/types/feServiceInstance";

export default function WeclappEditConnectionDetailPopup() {
    const { id } = useParams();
    ...
    const { data: serviceInstance } = useQuery({
        ...
        queryFn: () => fetchServiceInstance(id as string) as Promise<FeWeclappServiceInstanceDetails>,
    });
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="max-w-lg">
                <DialogHeader className="pb-4 border-b">
                    <DialogTitle>Edit Weclapp Configuration</DialogTitle>
                </DialogHeader>
