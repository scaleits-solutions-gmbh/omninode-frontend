...
import { Info, KeyRound, RefreshCcw, Copy, Check, CircleCheck } from "lucide-react";
import { useState } from "react";
import WeclappEditConnectionDetailPopup from "./WeclappEditConnectionDetailPopup";
        ...
        <CardContent className="space-y-6">
          <div className="space-y-4">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-sm font-mono bg-muted/50 p-2 rounded-md">https://scaleits.weclapp.com</p>
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center gap-2">
                <p className="text-sm font-mono bg-muted/50 p-2 rounded-md flex-1">1234***************</p>
                <Button
                  variant="ghost"
                  size="icon"
                  className="h-8 w-8"
