...
interface WeclappPermissionsSelectorProps {
  form: {
    Field: (props: { name: keyof WeclappPermissionsForm; children: (field: { name: string; state: { value: boolean }; handleChange: (value: boolean) => void }) => React.ReactNode }) => React.ReactNode;
  };
}

export default function WeclappPermissionsSelector({ form }: WeclappPermissionsSelectorProps) {
  return (
