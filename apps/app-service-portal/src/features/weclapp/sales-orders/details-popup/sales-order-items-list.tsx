...
import { salesOrderItemsColumns } from "./sales-order-items-columns";
...
export const SalesOrderItemsList = ({ salesOrder }: SalesOrderItemsListProps) => {
  ...
  return (
    <div>
      <h3 className="text-lg font-medium mb-3">Sales Order Items</h3>
      <Card>
            ...
            <Table>
              ...
              <TableBody>
                {table.getRowModel().rows?.length ? (
                  ...
                  <TableRow>
                    <TableCell
                      colSpan={salesOrderItemsColumns.length}
