import { CompanyRelationshipType, ResultType } from "@scaleits-solutions-gmbh/services";
...
export const getMockData = async (token: string): Promise<{result: apiCompanyInvite | undefined, resultType: ResultType}> => {
