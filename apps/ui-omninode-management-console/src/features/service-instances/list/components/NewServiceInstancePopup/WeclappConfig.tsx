...
export default function WeclappConfig({ onBack, onFinish }: WeclappConfigProps) {
  ...
  const isHostnameValid = (value: string) => {
    ...
    if (!value.includes(".weclapp.com")) return "Please enter a valid Weclapp hostname";
    return undefined;
  };
  ...
  const handleTestConnection = async (values: { hostname: string; apiKey: string }) => {
    setIsTesting(true);
        ...
        <Card className="border-2">
          <CardHeader className="flex flex-row items-center gap-4 pb-2">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <Badge variant="secondary" className="w-fit">CRM</Badge>
            </div>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Configure your Weclapp integration by providing your hostname and API key.
            </p>
          </CardContent>
        </Card>
