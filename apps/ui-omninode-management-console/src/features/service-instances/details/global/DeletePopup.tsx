        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="max-w-sm">
                ...
                <div className="space-y-4">
                    <Label htmlFor="instanceName">Type &ldquo;{instanceName}&rdquo; to confirm</Label>
                    <Input
                        id="instanceName"
                ...
                <div className="flex justify-end gap-2 mt-4">
                    ...
                    <Button variant="destructive" onClick={handleDelete} disabled={inputName !== instanceName}>
                        Delete
                    </Button>
                </div>
            </DialogContent>
