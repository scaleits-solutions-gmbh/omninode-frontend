...
import { fetchServiceInstanceUsersWithoutAccess } from "@/lib/apiClient/serviceInstances";
import { useParams } from "next/navigation";
import { Loader2, Search } from "lucide-react";
import SearchInput from "@/components/input/searchInput";
import { createColumns } from "./GrantUserAccessPopupCollumns";
import {
  Table,
  TableBody,
  TableRow,
                      ...
                      >
                        ...
                        <TableCell className="w-8">
                          <Checkbox
                            ...
                            aria-label={checked ? "Deselect user" : "Select user"}
                          />
                        </TableCell>
                      </TableRow>
                    );
