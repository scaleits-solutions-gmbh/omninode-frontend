...
import AcmpTenantSelector from "./AcmpTenantSelector";
import AcmpGroupSelector from "./AcmpGroupSelector";
import { AcmpFilterType } from "@scaleits-solutions-gmbh/services";
import AcmpPermissionsSelector from "./AcmpPermissionsSelector";
...
export default function AcmpCompanyAccessPermissionEditor({
  ...
  const form = useForm({
    defaultValues: {
      ...
      filterValue1: FeAcmpServiceInstanceCompanyWithAccess?.acmpFilterValue1 || "",
      filterValue2: FeAcmpServiceInstanceCompanyWithAccess?.acmpFilterValue2 || "",
      canViewDashboard:
