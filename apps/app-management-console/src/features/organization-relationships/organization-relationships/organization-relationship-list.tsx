...
export const OrganizationRelationshipList = () => {
  const { organizationId } = useParams();
  console.log("organizationId", organizationId);
  const [selectedRelationship, setSelectedRelationship] = useState<
    OrganizationRelationshipReadModel | undefined
  >(undefined);
  ...
  const { data, isLoading, error } = useAuthedQuery({
    queryKey: [
      "platformOrganizationRelationships",
      organizationId,
      search,
  ...
  const table = useReactTable({
    ...
    columns: createColumns({
      ...
      onRemoveRelationship: (relationship: OrganizationRelationshipReadModel) => {
        ...
        setShowRemoveRelationship(true);
      },
    }),
  ...
  return (
    <>
      {selectedRelationship && (
        <RemoveOrganizationRelationshipPopup
          show={showRemoveRelationship}
          relationship={selectedRelationship}
          currentOrganizationId={organizationId as string}
          onClose={() => {
            setShowRemoveRelationship(false);
