...
export const UsersList = () => {
  ...
  const [selectedUser, setSelectedUser] = useState<
    OrganizationMembershipReadModel | undefined
  >(undefined);
  ...
  const table = useReactTable({
    ...
    columns: createColumns({
      onViewDetails: (user: OrganizationMembershipReadModel) => {
        setSelectedUser(user);
      },
      onRemoveUser: (user: OrganizationMembershipReadModel) => {
        setSelectedUser(user);
        setShowRemoveUser(true);
      },
      onTransferOwnership: (user: OrganizationMembershipReadModel) => {
        setSelectedUser(user);
        setShowTransferOwnership(true);
      },
      onChangeRole: (user: OrganizationMembershipReadModel) => {
        setSelectedUser(user);
